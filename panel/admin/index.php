      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        <form class="form-inline mr-auto">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            <img alt="image" src="../../fundaments/assets/img/avatar/avatar-1.png" class="rounded-circle mr-1">
            <div class="d-sm-none d-lg-inline-block"><?php echo htmlspecialchars($_SESSION["username"]); ?></div></a>
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <a href="kill.php" class="dropdown-item has-icon text-danger">
